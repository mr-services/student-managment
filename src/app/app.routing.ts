...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            // Apps
            {path: 'apps', children: [
                {path: 'branches', loadChildren: () => import('app/modules/admin/apps/branches/branches.module').then(m => m.BranchesModule)},
                {path: 'students', loadChildren: () => import('app/modules/admin/apps/students/students.module').then(m => m.StudentsModule)},
